...
template <class T> class Optional {
    template <class U> struct optional_construct_helper {
...
public:
    ...
    template <class U> constexpr T getValueOR(U&& defaultValue) const&
    {
        return bool(*this) ? **this
                           : static_cast<T>(std::forward<U>(defaultValue));
    }

    template <class U> constexpr T getValueOR(U&& defaultValue) &&
    {
